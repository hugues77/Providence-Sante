...
<head>
  ...
  <title><?php  if(isset($title)){echo($title);} else echo 'Accès santé';  ?></title>
  <!-- MDB icon -->
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent-333">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active ml-5">
        <a class="nav-link" href="#"><i class="fas fa-home text-danger"></i>Accueil
          <span class="sr-only">(current)</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#"><i class="fas fa-desktop text-danger"></i>Présentation</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#"><i class="fas fa-history text-danger"></i>Notre histoire</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#"><i class="fas fa-sync-alt text-danger"></i>Fonctionnement</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#"><i class="fas fa-file-signature text-danger"></i>Contact</a>
      </li>
    </ul>
