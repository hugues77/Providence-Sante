    ...
    <div class="container-fluid mt-0">
        <div class="row align-items-center">
            <div class="col-12 col-md-6 form_head d-flex align-items-center">
                <div>
                    <h1 class="titre text-light ml-5 text-center">Association: Accès Santé</h1><hr>
                    <form class="form-inline">
                        <div class="form-group mx-sm-3 mb-2">
                            <a href="https://www.leetchi.com/c/acces-sante"><button class="btn btn-danger btn-cercle ml-5">Faire un Don</button></a>
                        </div>
                        <button type="submit" class="btn btn-danger btn-cercle mb-2">Devenir Membre</button>
                    </form>
                </div>
            </div>
            <!-- ici votre slogan  -->
...
<!-- debut section : Equité // SUITE devise_ Acces sante : ici changement des textes par jquery avec meme image-->

<div class="container-fluid mt-3 propos1">
    <div class="row">
        <div class="col-12 col-md-9">
            <p class="left">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quo voluptatem vero, iste doloribus aperiam atque illum, cumque culpa ea quasi dolor ad, consequuntur necessitatibus ex velit obcaecati aut in molestiae.
            Reprehenderit distinctio eius neque nemo reiciendis maxime consequuntur consequatur, quia enim rerum ipsa dolorem molestias eos magni ea iste doloremque expedita a in laborum, obcaecati eveniet eaque? Voluptates, ducimus quam.
            Soluta placeat sunt voluptatem maiores quos enim neque ipsa saepe eius, reprehenderit officia laborum excepturi aliquam itaque explicabo voluptatum pariatur mollitia eos tempora animi, ad facere architecto iste quae. Quod!
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis, sapiente iste. Velit unde, assumenda facilis vitae eius, voluptatibus beatae repudiandae, veritatis molestiae ad ipsum voluptatum temporibus debitis quaerat architecto. Odio!
            </p>
            <h5 class="muted text-danger"><i class="fas fa-heart"></i><strong>Accès Santé</strong></h5>
            <div> Publié Le 10/01/2020 by <a href="https://www.facebook.com/profile.php?id=100007098976923" target="_blank"><strong>Clara Ngala</strong></a>
            </div>

        </div>
        <div class="col-12 col-md-3 text-right">
            <img src="img/infirmiere3.png" width="300px" height="350px" class="" alt="">
        </div>
        
    </div>
</div>
<!-- fin section devise_ Acces sante -->

<!-- debut section2:partage SUITE devise_ Acces sante : ici changement des textes par jquery avec meme image-->

<div class="container-fluid mt-3 propos2">
    <div class="row">
        <div class="col-12 col-md-9">
            <p class="left">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quo voluptatem vero, iste doloribus aperiam atque illum, cumque culpa ea quasi dolor ad, consequuntur necessitatibus ex velit obcaecati aut in molestiae.
            Reprehenderit distinctio eius neque nemo reiciendis maxime consequuntur consequatur, quia enim rerum ipsa dolorem molestias eos magni ea iste doloremque expedita a in laborum, obcaecati eveniet eaque? Voluptates, ducimus quam.
            ...
            <h5 class="muted text-danger"><i class="fas fa-heart"></i><strong>Accès Santé</strong></h5>
            <div> Publié Le 10/01/2020 by <a href="https://www.facebook.com/ChristENelle" target="_blank"><strong>Christelle Kazadi</strong></a>
            </div>

        </div>
        <div class="col-12 col-md-3 text-right">
            <img src="img/infirmiere2.png" width="300px" height="350px" class="" alt="">
        </div>
...
<!-- debut section: Passionnement Humain/ SUITE devise_ Acces sante : ici changement des textes par jquery avec meme image-->

<div class="container-fluid mt-3 propos3">
    <div class="row">
        <div class="col-12 col-md-9">
            <p class="left">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quo voluptatem vero, iste doloribus aperiam atque illum, cumque culpa ea quasi dolor ad, consequuntur necessitatibus ex velit obcaecati aut in molestiae.
            Reprehenderit distinctio eius neque nemo reiciendis maxime consequuntur consequatur, quia enim rerum ipsa dolorem molestias eos magni ea iste doloremque expedita a in laborum, obcaecati eveniet eaque? Voluptates, ducimus quam.
            ...
            <h5 class="muted text-danger"><i class="fas fa-heart"></i><strong>Accès Santé</strong></h5>
            <div> Publié Le 10/01/2020 by <a href="https://www.facebook.com/tee.haagendazs" target="_blank"><strong>Blondine Bartolomeu</strong></a>
            </div>

        </div>
        <div class="col-3 col-md-3 text-right">
            <img src="img/infirmiere1.png" width="300px" height="350px" class="" alt="">
        </div>
    ...
    <div class="team">
      <div class="row d-flex align-items-center">
        <div class="col-12 col-md-5">
          ...
          <h3 class="mt-4 ml-4 titre text-justify ">Accès santé a amélioré la qualité des soins dispensés aux patients <br>
